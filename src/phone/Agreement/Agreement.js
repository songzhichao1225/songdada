    ...
    return (
      <div className="Agreement" >
        ...
        <div className="boss">
          ...
          <span className="block">4、截止报名时，活动匹配成功。<span className="weight">不管用户是否到场</span>，场馆方正常提供场地前提下（无用户投诉场馆未预留场地），平台方都须第一时间将扣除服务费后的场地费支付给场馆方；<span className="weight">平台服务费=场地费*8%。</span></span>
          ...
          <span className="block">5、<span className="weight">场馆方须支付场地费的8%作为平台服务费</span>，如场馆方给平台的价格为20元/小时，场馆方收到的场地费为18.4元/小时；</span>
