...
import homePh from '../homePh/homePh';
...
class homePagePh extends React.Component {
  ...
  shouldComponentUpdate(nexProps) {
    if (this.props.location === nexProps.location) {
      return false
    } else {
      return true
    }
  ...
  sitePh = () => {
    this.props.history.push('/homePh/sitePh')
    this.setState({ title: '场地设置' })

  }
  newsPh = () => {
    this.props.history.push('/homePh/newsPh')
    this.setState({ title: '消息' })

  }
  mine = () => {
    this.props.history.push('/homePh/minePh')
  ...
  render() {
    ...
    return (
      <div className="homePagePh">
        <audio id="audio" src="https://appstg.tiaozhanmeiyitian.com//uploads/Audio/2020-06-30/20200630103615656.mp3"></audio>
        <NavBar
          mode="dark"
          ...
          rightContent={<Popover mask
            ...
            overlay={[
              (<Item key="1" value="scan" style={{ fontSize: '0.7rem' }} data-seed="logId">{window.location.href.indexOf('flag=1') === -1 ? '前往官网' : '关闭'}</Item>),
            ]}
            align={{
        ...
        <div className="footer">
          <div className="footerSon">
            <div onTouchStart={this.homePh}>
              <i style={this.props.location.pathname === '/homePh/homePh' ? { display: 'none' } : { display: 'block' }}>
              ...
              <i style={this.props.location.pathname === '/homePh/homePh' ? { display: 'block' } : { display: 'none' }}>
              ...
              <span style={this.props.location.pathname === '/homePh/homePh' ? { color: '#D85D27' } : { color: '#000' }}>首页</span>

            </div>
            <div onTouchStart={this.orderPh}>
