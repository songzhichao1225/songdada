    ...
    return (
      <div className="forgetPasswordPh">
        ...
        <div className="boss">
          ...
          <div className="name">
            <Input.Password className="phone" prefix={<Icon type="unlock" style={{ color: 'rgba(0,0,0,.25)' }} />}  maxLength={8}onChange={this.pass} placeholder="请输入密码" />
          </div>

          <div className="name">
            <Input.Password className="phone" prefix={<Icon type="unlock" style={{ color: 'rgba(0,0,0,.25)' }} />} maxLength={8} onChange={this.passTwo} placeholder="请再次输入密码" />
          </div>
