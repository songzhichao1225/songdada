...
import { Card, List, InputItem, DatePicker, Picker, Toast } from 'antd-mobile';
import { Pagination, Spin, Drawer } from 'antd';
import 'antd-mobile/dist/antd-mobile.css';
import { getVenueMemberlist, AddVenueMember, getVenueMemberRecordsOfConsumption,getVenueMemberDetails } from '../../api';
...
class management extends React.Component {
  ...
  onClose=()=>{
    this.setState({visibleJoin:false,consumption:false,visibleJoinTwo:false})
  }
  ...
  visibleJoinTwo=(e)=>{
    ...
    this.setState({visibleJoinTwo:true})
  }
      ...
      <div className="management">
              ...
              this.state.memberList.map((item, i) => (
                <Card key={i} className="card">
                  ...
                  <Card.Body className="listDetails" style={{ fontSize: '0.75rem' }}>
                    <div>生日：{item.birthday}</div> <div>联系电话：{item.contactNumber}</div> <div>会员卡号：{item.cardNumber}</div>
                    ...
                    <div>有效日期：{item.effectiveDate}</div><span className="topUp" data-uuid={item.uuid} onClick={this.visibleJoinTwo}>充</span> <span className="topUp tui">退</span> <img src={require('../../assets/icon_pc_updata.png')} alt="img" />
                  </Card.Body>
                </Card>
              ))
            }
        ...
        >
          ...
          <List.Item arrow="empty" style={{ borderBottom: '1px solid #E9E9E9' }}>
            <InputItem
              ...
              onChange={(v) => { this.setState({ topUp: v }) }}
              style={{ padding: '0', left: '0.5rem', fontSize: '0.88rem' }}
        ...
        >
          ...
          <List.Item arrow="empty" style={{ borderBottom: '1px solid #E9E9E9' }}>
            ...
            <List.Item arrow="empty" className="lood" extra={this.state.birthdayTwo}  style={{ borderBottom: '1px solid #E9E9E9' }}>生日</List.Item>
          ...
          <List.Item arrow="empty" style={{ borderBottom: '1px solid #E9E9E9' }}>
            ...
            <List.Item arrow="empty" extra={this.state.gradeTwo===1?'普通会员':this.state.gradeTwo===2?'银卡会员':this.state.gradeTwo===3?'金卡会员':this.state.gradeTwo===4?'铂金会员':this.state.gradeTwo===5?'钻石会员':this.state.gradeTwo===6?'星耀会员':''} style={{ borderBottom: '1px solid #E9E9E9' }}>会员卡等级</List.Item>
