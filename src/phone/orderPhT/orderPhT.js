...
import { Pagination, Drawer, Spin,Row, Col } from 'antd';
import { getReservationActivitieslist, VenueSendMessage, getVenueSport, getVenueNumberTitleList, VenueNumberSporttypeSave,ContinuationRecord, DelVenueNumberTitle,BreakUpConsumptionDetails, getVenueNumberTitleSave, getVenueSporttypelist,DeductTheTimesOfClosing } from '../../api';
                  ...
                  <Card>
                    ...
                    <Card.Body className="cardBody">
                      <div>
                        ...
                        <span style={{float:'left',marginLeft:'0.5rem' }}>支付状态:{item.SiteMoneyStatus}</span>
                        <span style={item.reserve === 1 ? { display: 'none' } : {marginLeft:'6%',float:'left'}}>续时:<span style={{color:'#4A90E2'}} onClick={this.duration} data-uuid={item.uuid}>查看记录</span></span>
                        <span style={item.reserve === 1 ? { display: 'none' } : { display: 'block', width: '90px', float: 'left',marginLeft:'0.5rem' }}>应到人数:{item.Shouldarrive}人</span>
                      ...
                      <div>
                        ...
                        <span style={item.reserve === 1 ? { display: 'none' } : {marginLeft:'5%',display:'block',width:'90px',float:'left'}}>报名人数:{item.TrueTo}人</span>
