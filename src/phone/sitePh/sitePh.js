...
class sitePh extends React.Component {
    ...
    if (res.data.code === 2000) {
      if (this.state.siteEditorTwo === 0) {
        ...
        for (let i in upSportidTwo) {
          if (upSportidTwo[i].sportid === day) {
            this.setState({ maxNum: upSportidTwo[i].maxtablecount, numberMax: upSportidTwo[i].maxtablecount })
          }
        }
        this.setState({
  ...
  async getSetUpFieldSportId(data) {
    ...
    if (res.data.code === 2000) {
      ...
      for (let i in res.data.data) {
        ...
        ko.value = res.data.data[i].sportid
        arrT.push(ko)
      }
      console.log(arrT)
  ...
  projectTwo = e => {
    ...
    for (let i in upSportidTwo) {
      if (upSportidTwo[i].sportid === parseInt(e[0])) {
        this.setState({ numTwoMax: parseInt(upSportidTwo[i].maxtablecount), numTwo: parseInt(upSportidTwo[i].maxtablecount) })
      }
    }
  ...
  editorTwo = (e) => {
    ...
    let { upSportidTwo } = this.state
    for (let i in upSportidTwo) {
      if (upSportidTwo[i].sportid === this.state.projectTwoId) {
        this.setState({ numTwoMax: parseInt(upSportidTwo[i].maxtablecount), numTwo: parseInt(upSportidTwo[i].maxtablecount) })
      }
    }
  }
    ...
    return (
      <div className="sitePh">
          ...
          >
            <div className='drawSite'>
              ...
              <div className="sitePhlistSon">
                ...
                <Picker data={this.state.timeArrT} title="最短提前预定时间" onChange={this.timeChange} cols={1} className="forss">
        ...
        <div className={this.state.clickNum === 2 ? 'preferential' : 'none'} >
          ...
          <div className='preferentialTwo' style={this.state.getVenueDiscountList.length < 1 ? { display: 'none' } : {}}>
            {
        ...
        <div className={this.state.clickNum === 3 ? 'preferential' : 'none'} >
          ...
          <div className="preferentialTwo" style={this.state.getVenueSpecialList.length < 1 ? { display: 'none' } : {}}>
