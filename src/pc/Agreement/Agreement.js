    ...
    return (
      <div className="Agreement">
        ...
        <div className="content">
          ...
          <span className="block">4、截止报名时，活动匹配成功。不管用户是否到场，场馆方正常提供场地前提下（无用户投诉场馆<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;未预留场地），平台方都须第一时间将扣除服务费后的场地费或按照充值会员协议确定的场地费支付给场馆方；<span className="weight">平台服务费=场地费*8%(平台充值会员的场馆，服务费由平台给用户的售卖价与场馆给平台的会员价所产生的差价确定)。</span></span>
          <span className="block">5、当有用户投诉场馆未预留场地后，平台方须在24小时内安排推广员进行核实，根据最终核实情<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;况，决定是否将场地费支付给场馆方；</span>
          <span className="block">6、当场馆方申请提现时，平台须确保提现的场地费24小时内到账。否则平台每天须<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付1‰提现金额的滞纳金。</span>
