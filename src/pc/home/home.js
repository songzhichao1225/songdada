          ...
          <Menu theme="dark" selectedKeys={[sessionStorage.getItem('path')]} onSelect={this.kood} style={{marginTop:'-5px'}}>
            ...
            <Menu.Item key="7" onClick={this.wallet}>
              <Link to="/home/myWallet">
                ...
                <span>场地费支付<span style={this.state.ishaverecharge===1||this.state.ishaverecharge===2?{display:'block',width:'10px',height:'10px',float:'right',marginTop:'10px',borderRadius:'50%',background:'red'}:{display:'none'}}></span></span>
              </Link>
            </Menu.Item>
          </Menu>
