            ...
            <Form>
              <Form.Item >
                ...
                <div className="son">
                  ...
                  <Input.Password onChange={this.pass} style={{paddingLeft:'20px'}} maxLength={15} placeholder="请输入新密码" className="phone code" />
                </div>
                ...
                <div className="son">
                  ...
                  <Input.Password onChange={this.passTwo} style={{paddingLeft:'20px'}} maxLength={15} placeholder="请确认密码" className="phone confirm" />
                </div>
                </Form.Item>
              <Form.Item>
